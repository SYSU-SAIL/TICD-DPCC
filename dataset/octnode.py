...
class OctNode(IterableDataset):
    def __init__(self, root, data_type="train", max_depth=None, spatial_len=128, temporal_len=256, sample_rate=-1,
                 depth_decap={}):
        ...
        # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 共享内存 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        self.multi_manager = multiprocessing.Manager()
        self.shared_dict = self.multi_manager.dict()
        self.max_file_index = self.multi_manager.Value('i', 0)
    ...
    def __iter__(self):
        for file_index, file_path in enumerate(self.file_path):
            ...
            if file_index % num_workers != worker_id:
                ...
                # 第一个文件，无参考帧，但是标志从头开始
            if file_index == 0:
                self.max_file_index.value = file_index
            if file_index > self.max_file_index.value:
                self.max_file_index.value = file_index
            # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 加一个数量限制机制 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
